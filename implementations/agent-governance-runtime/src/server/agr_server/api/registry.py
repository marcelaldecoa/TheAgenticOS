...
async def list_agents(
    ...
    """List registered agents with pagination and filtering."""
...
@router.put("/agents/{agent_id}", response_model=AgentRecord)
async def update_agent(agent_id: str, update: AgentUpdate) -> AgentRecord:
